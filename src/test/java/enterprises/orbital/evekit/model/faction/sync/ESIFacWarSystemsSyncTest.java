...
public class ESIFacWarSystemsSyncTest extends RefTestBase {
  ...
  public void setup() throws Exception {
    ...
    ESIRefEndpointSyncTracker.getOrCreateUnfinishedTracker(ESIRefSyncEndpoint.REF_FW_SYSTEMS, 1234L);
  ...
  private void setupMock() throws Exception {
    ...
    EasyMock.expect(mockEndpoint.getFwSystemsWithHttpInfo(null, null, null))
