...
public class ESISovereigntyStructureSyncTest extends RefTestBase {
  ...
  public void setup() throws Exception {
    ...
    ESIRefEndpointSyncTracker.getOrCreateUnfinishedTracker(ESIRefSyncEndpoint.REF_SOV_STRUCTURE, 1234L);
  ...
  private void setupMock() throws Exception {
    ...
    EasyMock.expect(mockEndpoint.getSovereigntyStructuresWithHttpInfo(null, null, null))
